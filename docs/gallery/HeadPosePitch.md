...
- OFIQ section: `§7.4.11.3`
- ISO/IEC 29794-5: Head pose angle pitch frontal alignment
- ISO/IEC 19794-5: 8.2 pose
- ICAO 9303 P9: 3.2.3 frontal
- Alignment: `exact`, confidence: `verified`
- OFIQ versions: 1.1

## Degradation method

- Perspective pitch tilt [§7.4.11 yaw/pitch/roll]
