...
![IlluminationUniformity.scalar severity strip](gallery/images/IlluminationUniformity_strip.png)
...
- OFIQ section: `§7.3.3`
- ISO/IEC 29794-5: Illumination uniformity
- ISO/IEC 19794-5: 8.9 lighting
- ICAO 9303 P9: 3.2.3 lighting
- Alignment: `exact`, confidence: `verified`
- OFIQ versions: 1.1

## Degradation method

- ROI illumination asymmetry [§7.3.3]
